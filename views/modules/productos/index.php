...
/* @var $_SESSION['idClasificacion'] Clasificacion */
$_SESSION['idClasificacion'] = !empty($_GET['idClasificacion']) ? CategoriasController::searchForID(['id' => $_GET['idClasificacion']]) : NULL;
?>
<!DOCTYPE html>
<html>
<head>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <table id="tbl<?= $pluralModel ?>" class="datatable table table-bordered table-striped">
                                            ...
                                            <?php
                                            $arrProductos = array();
                                            if(!empty($_SESSION['idClasificacion'])){
                                                $arrProductos = $_SESSION['idClasificacion']->getProductosClasificaciones();
                                            }else{
                                            ...
                                            foreach ($arrProductos as $producto) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $producto->getClasificacion()->getNombre(); ?></td>
                                                    <td><?= $producto->getEstado(); ?></td>
                                                    <td><?=( $producto->getMedidaId() == null) ? '': $producto->getMedidas()->getNombre(); ?></td>
                                                    <td><?= ($producto->getMaterialId() == null) ? '': $producto->getMateriales()->getNombre(); ?></td>
                                                    <td><?= $producto->getMarcas()->getNombre(); ?></td>
