<?php
require_once("../../../app/Controllers/FacturaVentasController.php");
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-dark">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-shopping-cart"></i> &nbsp; Ver <?= $pluralModel ?></h3>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <table id="tbl<?= $nameModel ?>" class="datatable table table-bordered table-striped">
                                            ...
                                            <tbody>
                                            <?php
                                            $arrVentas = FacturaVentasController::getAll();
                                            /* @var $arrVentas FacturaVentas[] */
                                            foreach ($arrVentas as $venta) {
                                                ?>
                                                <tr>
                                                    <td><?= $venta->getId(); ?></td>
                                                    <td><?= $venta->getFecha()->format('d-m-y'); ?></td>
                                                    <td><?= GeneralFunctions::formatCurrency($venta->getMonto()); ?></td>
                                                    <td><?= $venta->getPersonasFacturaVentas()->getNombre(); ?> <?= $venta->getPersonasFacturaVentas()->getApellido(); ?></td>
                                                    <td><?= $venta->getEstado(); ?></td>
                                                    <td>


                                                            <a href="ShowDetalleVenta.php?id=<?php echo $venta->getId(); ?>"
                                                               style="background-color: blue"
                                                               type="button" data-toggle="tooltip" title="Detalle Venta"
                                                        ...
                                                        <?php if ($venta->getEstado() == "Proceso") { ?>
                                                            ...
                                                            <a type="button" onclick="return ConfirmacionFinalizar()"
                                                               style="background-color:chocolate"
                                                               href="../../../app/Controllers/MainController.php?controller=<?= $pluralModel ?>&action=finalize&Id=<?= $venta-> getId(); ?>"
