...
require("../../../app/Controllers/ClasificacionesController.php");
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <?php if (!empty($_GET["id"]) && isset($_GET["id"])) { ?>
                                <p>
                                <?php
                                $Dataclasificacion =ClasificacionesController::searchForID(["id" => $_GET["id"]]);
                                /* @var $Dataclasificacion Clasificaciones */
                                if (!empty($Dataclasificacion)) {
                                    ?>
                                    <div class="card-body">
                                        <!-- form start -->
                                        <form class="form-horizontal" method="post" id="<?= $nameForm ?>" name="<?= $nameForm ?>"
                                              action="../../../app/Controllers/MainController.php?controller=<?= $pluralModel ?>&action=edit">
                                            <input id="id" name="id" value="<?= $Dataclasificacion->getId(); ?>"
                                                   hidden required="required" type="text">
                                            <div class="form-group row">
                                                <label for="nombre" class="col-sm-2 col-form-label">Nombres</label>
                                                <div class="col-sm-10">
                                                    <input required minlength="2" maxlength="50" type="text" class="form-control" id="nombre"
                                                           name="nombre" value="<?= $Dataclasificacion->getNombre(); ?>"
