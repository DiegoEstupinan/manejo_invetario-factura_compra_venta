<?php
require_once("../../../app/Controllers/ClasificacionesController.php");
                                ...
                                <div class="row">
                                    <div class="col">
                                        <table id="tbl<?= $pluralModel ?>" class="datatable table table-bordered table-striped">
                                            ...
                                            <tbody>
                                            <?php
                                            $arrClasificaciones = ClasificacionesController::getAll();
                                            /* @var $arrClasificaciones Clasificaciones[] */
                                            foreach ($arrClasificaciones as $clasificacion) {
                                                ?>
                                                <tr>
                                                    <td><?= $clasificacion->getId(); ?></td>
                                                    <td><?= $clasificacion->getNombre (); ?></td>
                                                    <td>
                                                        <?php if($_SESSION['UserInSession']['rol'] == 'administrador') {?>
                                                        <a href="edit.php?id=<?= $clasificacion->getId(); ?>"
                                                           type="button" data-toggle="tooltip" title="Actualizar"
                                                           class="btn docs-tooltip btn-primary btn-xs"><i
                                                                    class="fa fa-edit"></i></a>
                                                        <?php } ?>
                                                        <a href="show.php?id=<?= $clasificacion->getId(); ?>"
