...
require("../../../app/Controllers/MedidasController.php");
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-green">
                            <?php if (!empty($_GET["id"]) && isset($_GET["id"])) {
                                $DataMedida = MedidasController::searchForID(["id" => $_GET["id"]]);
                                /* @var  $DataMedida Medidas */
                                if (!empty( $DataMedida)) {
                                    ?>
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-box"></i> &nbsp; Ver Información
                                            de <?= $DataMedida->getNombre() ?? '' ?></h3>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a role="button" href="edit.php?id=<?= $DataMedida->getId(); ?>" class="btn btn-primary float-right"
                                                   style="margin-right: 5px;">
