<?php
require_once("../../../app/Controllers/MedidasController.php");
                                    ...
                                    <div class="col">
                                        <table id="tbl<?= $pluralModel ?>" class="datatable table table-bordered table-striped">
                                            ...
                                            foreach ($arrMedidas as $medida) {
                                                ...
                                                <tr>
                                                    <td><?= $medida->getId(); ?></td>
                                                    <td><?= $medida->getNombre(); ?></td>
                                                    <td>
                                                        <a href="edit.php?id=<?= $medida->getId(); ?>"
                                                           type="button" data-toggle="tooltip" title="Actualizar"
                                                           class="btn docs-tooltip btn-primary btn-xs"><i
                                                                    class="fa fa-edit"></i></a>
                                                        <a href="show.php?id=<?= $medida->getId(); ?>"
